/**
 * Logo PAPER34 inliné (1,5 Ko) : aucune requête image dans la nav, le logo
 * est peint avec le premier rendu au lieu d'être l'élément LCP de la page
...
export default function LogoPaper34({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="m536.57,111.15h75.94v-19.08h-51.29c-4.68,9.38-13.66,15.85-24.65,19.08Z" />
