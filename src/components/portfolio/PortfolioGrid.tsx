  ...
  return (
    <>
      ...
      <section className="pb-24 md:pb-32 bg-bg-primary">
        ...
        {/* Fin de grille : la suite se passe sur Instagram */}
        {!hasMore && filtered.length > 0 && (
          <div className="flex flex-col items-center gap-3 py-10">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-border px-6 py-3 text-sm font-medium text-text-secondary transition-all duration-300 hover:text-text-primary hover:border-border-hover hover:bg-white/5"
            >
